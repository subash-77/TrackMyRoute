...
//Education Fragment                |
//----------------------------------|
public class EducationFragment extends Fragment implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
        ...
        textToSpeech = new TextToSpeech(getActivity(), new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (status == TextToSpeech.SUCCESS) {
                    // Text-to-Speech is successfully initialized
                } else {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
            ...
            //int compassMargin = getResources().getDimensionPixelOffset(R.dimen.compass_margin);
                    ...
                    (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            try {
                                ...
                                // Speak distance
                                String distance = distance1.getString("text");
                                textToSpeech.speak("Distance: " + distance, TextToSpeech.QUEUE_FLUSH, null);
                                // Speak directions
                                textToSpeech.speak(directionsText.toString(), TextToSpeech.QUEUE_ADD, null);
